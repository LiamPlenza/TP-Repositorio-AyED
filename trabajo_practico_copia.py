...
def menu_principal(camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja):
    clear_shell()
    ...
    while option != 0:
        ...
        if option == 1:
            ...
            camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja = menu_recepcion(camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja)
        elif option == 8:
          ...
          time.sleep(2)
          menu_principal(camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja)
...
def ingreso_de_datos(camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja): 
    ...
    if tipoCamion == "SOJA":
        ...
        camionMaiz = camionMaiz + 0
        pesoNetoMaiz = pesoNetoMaiz + 0
    elif tipoCamion == "MAIZ":
        patCamion = input("Ingrese la patente: ").upper()
        pesoNeto = float(input("Ingrese el peso bruto del camión: ")) - float(input("Ingrese la tara del camión: "))
        print("El peso neto del camión ingresado es: ",pesoNeto)
        camionMaiz = camionMaiz + 1
        pesoNetoMaiz = pesoNetoMaiz + pesoNeto
        #promPesoNetoM = pesoNetoMaiz / camionMaiz
        if pesoNetoMaiz < pesoMenorMaiz:
            pesoMenorMaiz = pesoNetoMaiz
            patMenorMaiz = patCamion
        camionSoja= camionSoja + 0
        pesoNetoSoja = pesoNetoSoja + 0
    else: 
        print("Ingrese un Proucto valido")
        time.sleep(2)
        clear_shell()
        ingreso_de_datos(camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja)
    return camionMaiz, pesoNetoMaiz, patMenorMaiz, pesoMenorMaiz, camionSoja, pesoNetoSoja, patMayorSoja, pesoMayorSoja
